                ...
                >
                    ...
                    {matchedLine ? (
                        ...
                        >
                            ...
                            <p className="truncate text-[11px] text-white/55">{track.user?.username}</p>
                        </div>
                    )}
                    ...
                    {kind === 'vibe' && (
                        <div
                            className="absolute top-2 left-2 text-accent/70 group-hover:text-accent transition-colors duration-300">
