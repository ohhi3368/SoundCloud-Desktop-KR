...
import {getArtistDisplay, getArtistTarget, getDisplayTitle, getParticipants,} from '../../lib/track-display';
            ...
            <div className="relative p-6 md:p-8 flex flex-col gap-7">
                <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 lg:gap-8">
                  ...
                  {track.genre}
                            ...
                            {year && (
                                <span
                                    className="text-[10px] font-semibold px-2.5 py-1 rounded-full bg-white/[0.05] text-white/40 border border-white/[0.06] tabular-nums">
                  {year}
                </span>
                            )}
                        </div>
                        ...
                        <div className="mt-4">
                            <div
                                className={`inline-flex items-center gap-2.5 ${
                                    artistTarget ? 'cursor-pointer group/artist' : ''
                                }`}
                            ...
                            >
                                {track.user.avatar_url && (
                                    <img
                                        ...
                                        alt=""
                                        className="w-7 h-7 rounded-full ring-1 ring-white/[0.1] group-hover/artist:ring-white/[0.22] transition-all duration-200"
                                    />
                                )}
                                <span
                                    className="text-[15px] font-medium text-white/75 group-hover/artist:text-white transition-colors">
                  {ad.primary}
                </span>
                    ...
                    {t(`track.uploadKind.${ad.uploadKind}`)}
                            ...
                            {(participants || ad.uploader) && (
                                <div
                                    className="mt-1.5 text-[12px] text-white/40 flex flex-wrap items-center gap-x-1.5 gap-y-0.5 justify-center lg:justify-start">
