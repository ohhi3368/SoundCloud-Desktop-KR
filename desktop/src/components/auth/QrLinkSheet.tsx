  ...
  ({ open, onOpenChange, mode, onSuccess }: QrLinkSheetProps) => {
    ...
    return (
        <Modal open={open} onOpenChange={onOpenChange}>
            <ModalContent size="sm" showClose={false} zClass="z-[100]">
                <div
                ...
                <div className="relative p-7" style={{isolation: 'isolate'}}>
                    <ModalClose
                        className="absolute top-4 right-4 p-1.5 rounded-lg text-white/20 hover:text-white/60 hover:bg-white/[0.06] transition-colors cursor-pointer">
                        <X size={14}/>
                    </ModalClose>
