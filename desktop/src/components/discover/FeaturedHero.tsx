                ...
                <div className="relative flex items-center gap-6 p-6">
                    ...
                    >
                        {cover ? (
                            ...
                            <div
                                className="w-full h-full flex items-center justify-center bg-gradient-to-br from-white/[0.04] to-white/[0.01]">
                    ...
                    <div className="flex-1 min-w-0 py-1">
                        ...
                        <div className="flex items-center gap-3 mt-4 flex-wrap">
                            {track.genre && (
                                <span
                                    className="text-[10px] font-medium px-2.5 py-1 rounded-full bg-white/[0.06] text-white/45 border border-white/[0.06]">
                  {track.genre}
                </span>
                            )}
            ...
            <div className="relative flex items-center gap-6 p-6">
                ...
                >
                    ...
                    {playlist.track_count != null && (
                        <div
                            className="absolute bottom-2 right-2 flex items-center gap-0.5 text-[10px] font-medium bg-black/50 backdrop-blur-md text-white/70 px-2 py-0.5 rounded-full">
                            <ListMusic size={10}/>
...
const FeaturedUserHero = React.memo(function FeaturedUserHero({user}: { user: SCUser }) {
    ...
    return (
        ...
        >
            ...
            <div className="relative flex items-center gap-6 p-6">
                <div
                    className="w-[160px] h-[160px] rounded-full overflow-hidden shrink-0 shadow-2xl ring-1 ring-white/[0.1]">
                    {avatar ? (
                        <img
                            src={avatar}
                            alt={user.username}
